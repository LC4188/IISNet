...
def parse_args(arg_mode):
    ...
    parser.add_argument('-lr', type=float, default=0.11, help='0.11 learning rate')
    ...
    ''' about CCA '''
    parser.add_argument('-temperature_attn', type=float, default=8.0, metavar='gamma', help='temperature for softmax in computing cross-attention')
